  ...
  const handleSignOut = () => {
    ...
    const NavLinks = (
        <>
          ...
          <li>
            <NavLink to="/about">All Tourists Spot</NavLink>
          </li>
          <li>
            <NavLink to="/blog">Add Tourists Spot</NavLink>
          </li>
          <li>
            <NavLink to="/estate">My List</NavLink>
          </li>
          <li>
            <NavLink to="/self">Touris Feedback</NavLink>
          </li>
